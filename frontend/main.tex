...
% --- Configuración de Comillas en Español ---
% Si las comillas dobles (") no se renderizan correctamente como «guillemets»
% o si prefiere usar comillas rectas, puede ajustar la configuración.
%
% 1. Para forzar comillas rectas (") en lugar de «guillemets»:
%    Puede usar el paquete csquotes con la opción autostyle=false:
%    \usepackage[autostyle=false]{csquotes}
%    Y luego usar \enquote{texto} para las comillas.
%
% 2. Si desea que babel maneje las comillas automáticamente (por defecto,
%    "texto" debería convertirse en «texto» con la opción spanish de babel):
%    Asegúrese de que su compilador LaTeX esté configurado correctamente.
%    Si aún ve comillas rectas, puede intentar usar \og y \fg para guillemets
%    o \glqq y \grqq para comillas dobles angulares.
%
% Por ahora, el documento utiliza comillas dobles estándar (") que babel
% debería interpretar como guillemets en español.
% -------------------------------------------
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
